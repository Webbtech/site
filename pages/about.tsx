...
// this layout is from https://tailwindui.com/components/marketing/sections/content-sections - Two columns with image

export default function About() {
  return (
    <Layout title='About | Webbtech'>
              ...
              <div className='relative text-base mx-auto max-w-prose lg:max-w-none'>
                <figure>
                  ...
                  <figcaption className='mt-3 flex text-sm text-gray-500'>
                    ...
                    <span className='ml-2'>
                      Photograph by{' '}
                      <a href='https://unsplash.com/@pavement_special'>https://unsplash.com/@pavement_special</a>
                    </span>
                  </figcaption>
                </figure>
              </div>
